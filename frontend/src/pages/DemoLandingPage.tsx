...
const features = [
  ...
  { icon: Zap, title: 'Open Source', desc: 'Self-hosted and transparent. No vendor lock-in, no data brokers. Inspect the code, run it yourself, trust the code.', color: 'text-violet-600 bg-violet-50 dark:text-violet-400 dark:bg-violet-950/30' },
]
    ...
    <div className="min-h-screen bg-background">
      ...
      <footer className="border-t border-border px-6 py-6 text-center">
        <p className="text-xs text-muted-foreground">
          Made with ❤️ by{' '}
          <a href="https://x.com/sureshdsk" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">@sureshdsk</a>
          {' | '}
          <Link to="/about" className="text-primary hover:underline">About FinnLens</Link>
        </p>
      </footer>
    </div>
  )
